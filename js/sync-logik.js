...
//   { ts, kind, alter, art: 'aufgabe'|'eintragen'|'aufsagen', typ, richtig, gesamt, zeit_ms }
...
export function ereignisAufgabe({ kind, alter, aufgabentyp, warRichtig, zeitMs, ts }) {
...
export function ereignisEintragen({ kind, alter, richtig, fehler, verraten, ts }) {
...
export function ereignisAufsagen({ kind, alter, zeitMs, ts }) {
  return basis({ kind, alter, ts }, {
